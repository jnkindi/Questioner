...
| /api/v1/meetups/:id/images | POST | Add a new images on meetup |
| /api/v1/meetups/:id/images | DELETE | Delete image on meetup |
| /api/v1/meetups/:id/tags | POST | Add a new tags on meetup |
| /api/v1/meetups/:id/tags | DELETE | Delete tag on meetup |
